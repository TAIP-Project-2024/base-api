...
def main():
    ...
    with open("resources/graphs/example.graphml", "rb") as file:
    ...
    if drawing_file:
        print("Drawing content preview:", drawing_file[:300])

    # Update the drawing with different content
    with open("resources/drawings/simple_drawing.html", "rb") as file:
